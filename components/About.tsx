        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              بدأت رحلة "سدر الجوري" من إيمان عميق بكنوز الطبيعة التي وهبنا الله إياها. لاحظنا كيف اعتمدت جداتنا على أوراق السدر المطحونة للحفاظ على جمال شعرهن وصفاء بشرتهن قبل انتشار المستحضرات الكيميائية.
            </p>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="border-r-4 border-nature-500 pr-6 my-8">
              <p className="text-xl font-medium text-gray-800 italic">
                "في سدر الجوري، نحن لا نبيع مجرد منتجات، بل نعيد إحياء تقاليد جمالية أصيلة وصحية."
              </p>
            </div>
          </div>
