    ...
    <div className="bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose lg:prose-xl prose-nature">
        ...
        <div className="flex items-start mb-8 bg-blue-50 p-6 rounded-xl border border-blue-100">
            ...
            <div>
                ...
                <p className="text-blue-700 text-sm mt-1 m-0">
                    السدر يُعرف أيضاً باسم "النبق"، وهو الثمر الذي تنتجه الشجرة. كما تسمى باللغة الإنجليزية <strong>Jujube</strong> (Jujube Tree)، وقد ورد ذكر السدر في القرآن الكريم 4 مرات.
                </p>
            </div>
        </div>

        <h2 className="text-2xl font-bold text-gray-900 mb-4">شجرة السدر (Ziziphus Spina-Christi)</h2>
        <p className="text-gray-700 leading-loose mb-6">
            <strong>شجرة السدر</strong> (Jujube) هي شجرة كثيفة الأوراق، تنتمي للفصيلة العنابية. تتميز بتحملها للظروف الصحراوية القاسية، وتنتشر في الجزيرة العربية. 
        ...
        <p className="text-gray-700 leading-loose mb-6">
            ...
            في "سدر الجوري"، نحن نستخدم <strong>السدر البري</strong> لمنتجات العناية نظراً لتركيز الفوائد في أوراقه.
        </p>
