...
export const AIExpert: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'model',
      text: 'أهلاً بكِ عزيزتي! أنا خبيرة الجمال في "سدر الجوري". يسعدني مساعدتك في كل ما يخص العناية بشعرك وبشرتك باستخدام السدر. هل تبحثين عن وصفة لتكثيف الشعر أو ماسك لنضارة الوجه؟',
      timestamp: new Date()
    }
  ]);
