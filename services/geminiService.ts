...
export const getGeminiResponse = async (
  ...
  try {
    ...
    const systemInstruction = `
      ...
      معلومات عن الشركة:
      - نبيع منتجات العناية الطبيعية المستخلصة من شجرة السدر المباركة (المعروفة عالمياً باسم Jujube).
      ...
      مجالات خبرتك:
      1. شجرة السدر (النبق أو Jujube): شجرة مباركة، فوائد أوراقها القديمة في الطب الشعبي والتجميلي.
      ...
      مهامك:
      1. الإجابة على أسئلة الزوار حول فوائد السدر (Jujube) للشعر والبشرة.
